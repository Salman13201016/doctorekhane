...
router.register('ambulance-profile', views.AmbulanceProfileView, basename='ambulance-profile')
router.register('ambulance-profile-list', views.AmbulanceProfileListView, basename='ambulance-profile-list')
